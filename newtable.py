...
def process_img(img):
    resize = cv2.resize(img, None, fx=1.5, fy=1.5, interpolation=cv2.INTER_LINEAR)
...
print("vertical cluster", len(vertical_clusters))
mg_clus = draw_line_clusters(image, 'h', horizontal_clusters)
# mg_clus = draw_line_clusters(image, 'v', vertical_clusters)
# print(mg_clus)
cv2.imshow("c", mg_clus)
